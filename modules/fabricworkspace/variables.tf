...
variable "workspace_capacity_id" {
  ...
  default     = null
  validation {
    condition     = var.workspace_capacity_id == null || length(split("/", try(var.workspace_capacity_id, ""))) == 9
...
#   default     = null
#   validation {
#     condition     = var.workspace_domain == null || length(try(var.workspace_domain_id, "")) > 2
#     error_message = "Please specify a valid capacity id."
#   }
# }
