resource "azurerm_monitor_diagnostic_setting" "diagnostic_setting_cosmosdb_account" {
  ...
  dynamic "enabled_log" {
    iterator = entry
    for_each = data.azurerm_monitor_diagnostic_categories.diagnostic_categories_cosmosdb_account.log_category_groups
    content {
  ...
  dynamic "metric" {
    iterator = entry
    for_each = data.azurerm_monitor_diagnostic_categories.diagnostic_categories_cosmosdb_account.metrics
    content {
