resource "azurerm_monitor_diagnostic_setting" "diagnostic_setting_communication_service" {
  ...
  dynamic "enabled_log" {
    iterator = entry
    for_each = data.azurerm_monitor_diagnostic_categories.diagnostic_categories_communication_service.log_category_groups
    content {
  ...
  dynamic "metric" {
    iterator = entry
    for_each = data.azurerm_monitor_diagnostic_categories.diagnostic_categories_communication_service.metrics
    content {
